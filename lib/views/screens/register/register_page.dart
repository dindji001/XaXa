...
import 'package:kub_app/views/screens/login/login_page.dart';
import 'package:kub_app/views/screens/register/ftp-page.dart';
                ...
                children: [
                  RichText(
                    text: TextSpan(
                      ...
                      children: [
                        TextSpan(
                            text: 'Creer un compte compte KUB ',
                            style: TextStyle(
                                color: AppTheme.color.primaryColor,
                                fontSize: 24)),
                      ],
            ...
            child: Column(
              children: [
                ...
                CButton(title: 'Continuer', onPressed: () {
                  routeAnimation(context, VerifyPhoneOtp(), );
                }),
                 SizedBox(
                      height: 50,
                    ),
